...
public void verifyCareersPage() throws InterruptedException {
  ...
  log.info("============Test ended[  verify Careers Page when clicking on the Careers link on Homepage  ] =============");
...
/*
 * Validate the 'back to home page' link is functioning when user clicks on the find a doc page 
 */
// demo 4 
@Test(groups = { "HomePage", "Smoke" }, enabled = false)
